...
- Solution URL: [Solution URL](https://github.com/nishanth1596/fylo-data-storage-component)
- Live Site URL: [Live site URL](https://nishanth-fylo-data-storage-component.netlify.app/)
...
1. Clone this repository:
   ...
   ```bash
   git clone https://github.com/nishanth1596/fylo-data-storage-component.git
   ```
...
Google Fonts - I used the Raleway Display font from Google Fonts to style the text.
